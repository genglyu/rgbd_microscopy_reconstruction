...
if __name__ == "__main__":
    ...
    base = visualize_textured_mesh_panda3d.MicroscopyApp()
    # base.init_virtual_microscope_camera()
    base.load_textured_triangles(triangle_infos,
                                 merged_texture_dir=join(config["path_data"], config["merged_texture_dir"]))
